 ...
 */
export declare enum ConfigProfileType {
    LOW = "low",
    STANDARD = "standard",
    HIGH = "high"
}
...
export declare class ConfigProfile {
     ...
     * Predefined profiles
     */
    static readonly LOW: ConfigProfile;
    static readonly STANDARD: ConfigProfile;
    static readonly HIGH: ConfigProfile;
    /**
     * Select profile based on memory size (GB)
     */
    static selectFor(memoryGB: number): ConfigProfile;
    /**
     * Get all available profiles
     */
    static all(): ConfigProfile[];
    private validate;
}
