...
export class GdprDeleteRequest {
    ...
    requestedBy;
    requestDate;
    constructor(inn, requestedBy, requestDate) {
        this.inn = inn;
     ...
     */
    static create(inn, requestedBy, requestDate = new Date()) {
    ...
    static fromParams(params) {
        return GdprDeleteRequest.create(params.inn, params.userId, new Date());
    }
    /**
