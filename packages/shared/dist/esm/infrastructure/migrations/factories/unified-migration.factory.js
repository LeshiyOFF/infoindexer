...
import { UnifiedMigrationService, MigrationDiscovererService, MigrationApplierService } from '../domain/services';
 ...
 */
export function createUnifiedMigrationOrchestrator(params) {
    ...
    const discoverer = new MigrationDiscovererService(metadataParser, params.migrationsBaseDir);
    // Domain Layer - Applier
    const applier = new MigrationApplierService(migrationRunner, params.migrationsBaseDir);
 ...
 */
export function createClickHouseMigrationAdapter(clickhouseClient) {
 ...
 */
export function createUnifiedMigrationService(params) {
    ...
    const discoverer = new MigrationDiscovererService(metadataParser, params.migrationsBaseDir);
    const applier = new MigrationApplierService(runner, params.migrationsBaseDir);
