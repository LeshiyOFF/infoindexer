...
import type { IClickHouseConfig } from './infrastructure/ports/i-clickhouse-config.port';
/**
 ...
 */
export declare const clickhouseClient: ClickHouseClient;
/**
 ...
 * ```
 */
export declare function createClickHouseClient(config?: IClickHouseConfig): ClickHouseClient;
