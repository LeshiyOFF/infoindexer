 ...
 */
export type GetSanctionsBatchResponse = ApiResponse<
  Readonly<Record<string, readonly SanctionDTO[]>>
>;
 ...
 */
export type DeleteSanctionsResponse = ApiResponse<{ readonly deleted: number }>;
