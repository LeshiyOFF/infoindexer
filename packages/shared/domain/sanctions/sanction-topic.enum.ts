 ...
 */
export const ALL_SANCTION_TOPICS: readonly SanctionTopic[] = Object.values(SanctionTopic) as readonly SanctionTopic[];

/**
 * Проверяет является ли строка валидным SanctionTopic
 */
export function isValidSanctionTopic(value: string): value is SanctionTopic {
  return ALL_SANCTION_TOPICS.includes(value as SanctionTopic);
}
