 ...
 */
export declare enum ExemptionCriteria {
    /**
     * Не освобождён
 ...
 * Readonly для иммутабельности.
 */
export declare const ALL_EXEMPTION_CRITERIA: readonly ExemptionCriteria[];
/**
 ...
 * ```
 */
export declare function isValidExemptionCriteria(value: string): value is ExemptionCriteria;
