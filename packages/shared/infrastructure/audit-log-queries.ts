 ...
 */
export function createAuditLogSelectByUser(
  database: string,
 ...
 */
export function createAuditLogSelectByResource(
  database: string,
  tableName: string = 'audit_log'
): string {
  return `
 ...
 */
export function createAuditLogSelectByType(
  database: string,
  tableName: string = 'audit_log'
): string {
  return `
 ...
 */
export function createAuditLogCountByUser(
  database: string,
  tableName: string = 'audit_log'
): string {
  return `
 ...
 */
export function createAuditLogStats(
  database: string,
  tableName: string = 'audit_log'
): string {
  return `
