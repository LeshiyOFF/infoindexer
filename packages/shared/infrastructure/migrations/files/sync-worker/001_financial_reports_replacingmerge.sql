...
-- ═══════════════════════════════════════════════════════════════════
-- Materialized View для real-time агрегации финансовых данных
-- ═══════════════════════════════════════════════════════════════════
--
-- Architecture Decision:
-- - MV создаётся в той же миграции что и таблица financial_reports
-- - Это гарантирует правильный порядок (таблица → MV)
-- - AggregatingMergeTree для хранения агрегатных состояний
-- - Auto-updates на каждый INSERT в financial_reports
--
-- Примечание: без POPULATE — MV заполнится новыми данными по мере поступления
-- ═══════════════════════════════════════════════════════════════════
