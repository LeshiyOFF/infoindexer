...
export class CircuitBreakerFactory {
  ...
  static forClickHouse(
    ...
    return new CircuitBreakerAdapter(
      name,
      CircuitBreakerConfigVO.forClickHouse(),
      enableMetrics,
      events
    );
  }
  ...
  static forTesting(
    ...
    return new CircuitBreakerAdapter(
      name,
      CircuitBreakerConfigVO.forTesting(),
      false,
      events
    );
  }
   ...
   */
  static null(name = 'null-circuit-breaker'): ICircuitBreakerPort {
 ...
 */
export function createCircuitBreakerForClickHouse(
  name: string
): ICircuitBreakerPort {
 ...
 */
export function createCircuitBreakerForAPI(
  name: string
): ICircuitBreakerPort {
 ...
 */
export function createNullCircuitBreaker(
  name?: string
): ICircuitBreakerPort {
