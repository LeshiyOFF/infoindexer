...
exports.InnNormalizer = void 0;
/**
 * Value Object для нормализации INN
 */
class InnNormalizer {
    static RU_INN_PREFIX = 'ru-inn-';
    static PREFIX_LENGTH = 7; // "ru-inn-".length
    static INN_START_INDEX = 8; // После префикса
    /**
     ...
     */
    static isInnFormat(id) {
        return id?.startsWith(this.RU_INN_PREFIX) ?? false;
    }
}
exports.InnNormalizer = InnNormalizer;
