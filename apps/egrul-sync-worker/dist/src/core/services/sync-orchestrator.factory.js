...
function createSyncOrchestrator(deps) {
    const { identityMapping, denormalization, merger, repository, syncStateStorage, progressReporter, enrichment } = deps;
