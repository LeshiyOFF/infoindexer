...
exports.ConsoleMetricsAdapter = void 0;
/**
...
class ConsoleMetricsAdapter {
     ...
     * @param tags - Опциональные теги
     */
    recordProgress(operation, percentage, tags) {
     ...
     */
    logMetric(type, name, value, tags, icon, color) {
...
exports.ConsoleMetricsAdapter = ConsoleMetricsAdapter;
