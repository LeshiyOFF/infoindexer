 ...
 * ```
 */
export { CircuitState } from './types/circuit-breaker.types';
export type { CircuitError, CircuitResult, CircuitStats, CircuitBreakerConfig } from './types/circuit-breaker.types';
/**
...
export interface ICircuitBreakerPort {
     ...
     * ```
     */
    executeWithFallback<T>(fn: () => Promise<T>, fallback: (error: import('./types/circuit-breaker.types').CircuitError) => Promise<T>): Promise<T>;
    /**
