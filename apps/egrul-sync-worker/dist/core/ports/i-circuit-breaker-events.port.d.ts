 ...
 */
export type StateChangeReason = 'threshold_exceeded' | 'timeout_elapsed' | 'success_threshold' | 'manual_reset';
/**
 ...
 */
export type CircuitBreakerEvent = StateChangeEvent | FailureEvent | SuccessEvent | ResetEvent;
/**
