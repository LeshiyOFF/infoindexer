...
import type { IHealthCheck, ComponentHealth, SystemHealthResult } from '../domain/ports/i-health-check.port';
 ...
 */
export declare class HealthCheckService implements IHealthCheck {
