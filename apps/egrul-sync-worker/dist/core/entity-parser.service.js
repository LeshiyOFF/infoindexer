...
exports.EntityParserService = void 0;
...
class EntityParserService {
    ...
    parseDirectorship(entity) {
        ...
        return {
            ...
            start_date: (0, date_parser_1.parseDate)(entity.properties.startDate?.[0]),
            end_date: (0, date_parser_1.parseNullableDate)(entity.properties.endDate?.[0])
        };
    }
    /**
     ...
     */
    extractTemporalMetadata(entity) {
...
exports.EntityParserService = EntityParserService;
